...
export async function PUT(request: Request, context: { params: Promise<{ localId: string }> }) {
...
export async function DELETE(_: Request, context: { params: Promise<{ localId: string }> }) {
  const session = await getSessionHeaders();
