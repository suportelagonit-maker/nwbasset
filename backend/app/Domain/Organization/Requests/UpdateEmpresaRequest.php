...
class UpdateEmpresaRequest extends FormRequest
{
    ...
    {
        $empresaId = (int) ($this->route('empresa')?->id ?? 0);
        ...
        return [
            'razao_social' => [
                ...
                'string',
                'max:180',
                function (string $attribute, mixed $value, \Closure $fail) use ($empresaId, $razaoSocial): void {
            ...
            'nome_fantasia' => [
                ...
                'string',
                'max:180',
                function (string $attribute, mixed $value, \Closure $fail) use ($empresaId, $nomeFantasia): void {
                    $exists = DB::table('empresas')
            ...
            'cnpj' => ['sometimes', 'required', 'string', 'max:18', Rule::unique('empresas', 'cnpj')->ignore($empresaId)],
